class Player extends Sprite {
    ...
    move(x, y) {
        let xStep = this.boundaryRect.outsideHorizontal(xStep + this.position.x) ? 0 : GameSetting.playerMoveStep * x;
        let yStep = this.boundaryRect.outsideHorizontal(xStep + this.position.y) ? 0 : GameSetting.playerMoveStep * y;
