function resetPlayer() {
    if (!GameManager.player) {
        ...
        GameManager.player = new Sprite(GameSetting.playerDivName, new Point(GameSetting.playerStart.x, GameSetting.playerStart.y), asset.fileName, new Size(asset.width, asset.height))
    }
}
