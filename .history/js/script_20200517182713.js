...
function updateDashboard() {
    ...
    gameHistory.forEach((element, i) => {
        ...
        let text = '<div class="row score"><div class="col col-sm-2"><img src="img/' + ++i + '.png" width=64 height=64></div><div class="col col-sm-10">' + element.user + ": " + element.highScore + '</div></div>'
