...
function updateDashboard() {
    ...
    gameHistory.forEach((element, i) => {
        ...
        let text = '<div class="row score"><div class="col col-sm-4"><img src="img/' + ++i + '.png" width=64 height=64></div><div class="col col-sm-8">' + element.user + ": " + element.highScore + '</div></div>'
